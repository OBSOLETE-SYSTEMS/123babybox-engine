...
// (Optional: STUDIO_MODEL to override the model, default gemini-2.5-flash.)
// Until the key is set, the Studio tab shows a friendly "goes live on deploy" note.
    ...
    const r = await fetch(url, {
      ...
      body: JSON.stringify({
        ...
        generationConfig: {
          ...
          // CRITICAL: disable extended thinking or Flash is slow (see feedback_gemini_thinking_budget).
